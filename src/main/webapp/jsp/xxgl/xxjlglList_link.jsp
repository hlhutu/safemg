...
<script>
	var selectUrl = "${ctx}/jsp/xxjlgl/select.do";

	var obj = new Object();
	if("${param.xxkId}"!="undefined" && "${param.xxkId}"!=undefined){
		obj.xxjlgl_xxkid = "${param.xxkId}";
	}
	...
	$(window).ready(function() {
		...
		ajax(obj, function(result) { // 查询业务数据
			if ("error" == result.resCode) {
				...
				//表格填充
				$("#xxjl_table").bootstrapTable("load",result.datas);
			}
		});
		//初始化表格框
		var params = {
		...
		initBootStrapTable($("#xxjl_table"),params);
	});
				...
				<div class="ibox float-e-margins">
					<form id="thisform" class="form-horizontal" role="form" onsubmit="return false;">
						<div class="ibox-title">
							<h5>
								<class="fa fa-file-o a-clear"></i> 学习记录详情
							</h5>
						...
						<div class="ibox-content"> 
							  <div class="form-group" id="list_file_div">
							    <div class="col-sm-12">
							      <table id="xxjl_table" class="table" style="width: 100%"></table>
							    </div>
							  </div>
						</div>
					</form>
