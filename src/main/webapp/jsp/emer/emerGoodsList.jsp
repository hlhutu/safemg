...
<script>
	var selectUrl = "${ctx}/emerGoods/select.do";
	var insertUrl = "${ctx}/emerGoods/insert.do";
	var updateUrl = "${ctx}/emerGoods/update.do";
	var deleteUrl = "${ctx}/emerGoods/delete.do";

	$(window).ready(function() {
		$("#rep_name").html("${param.rep_name}");
		var dtParam = {
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>
							<i class="fa fa-file-o a-clear"></i> 应急-物资（<span id="rep_name"></span>）
						</h5>
					...
					<div class="ibox-content">
						...
						<div class="form-horizontal clearfix">
							<div class="col-sm-6 pl0">
								<s:access url="${basePath}/biz/emerGoods/insert.do">
									<button class="btn btn-sm btn-success" id="btn-insert">
										<i class="fa fa-plus"></i> 新增
									</button>
								</s:access>
								<s:access url="${basePath}/biz/emerGoods/update.do">
									<button class="btn btn-sm btn-success" id="btn-update">
										<i class="fa fa-edit"></i> 修改
									</button>
								</s:access>
								<s:access url="${basePath}/biz/emerGoods/delete.do">
				...
				<form id="editForm" class="form-horizontal key-13" role="form" onsubmit="return false;">
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">应急物资</label>
							<div class="col-sm-10">
								<input type="text" class="input-sm form-control validate[required]" name="goods_name" id="goods_name">
								<input type="text" class="input-sm form-control" name="rep_id" id="rep_id" value="${param.rep_id}" style="display: none;">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">数量</label>
							<div class="col-sm-4">
								<input type="number" class="input-sm form-control validate[required]" name="goods_count" id="goods_count" value="100">
							</div>
							<label class="col-sm-2 control-label">物资单位</label>
							<div class="col-sm-4">
								<input type="text" class="input-sm form-control validate[required]" name="goods_unit" id="goods_unit" value="个">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="input-sm form-control" name="goods_no" id="goods_no">
							</div>
						</div>
						<div class="form-group">
