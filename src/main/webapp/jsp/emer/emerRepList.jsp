...
<jsp:include page="/jsp/base/base.jsp"></jsp:include>
	...
	<script>
	var selectUrl = "${ctx}/emerRep/select.do";
	var insertUrl = "${ctx}/emerRep/insert.do";
	var updateUrl = "${ctx}/emerRep/update.do";
	var deleteUrl = "${ctx}/emerRep/delete.do";
			...
			},
			{
				...
				"render": function (data, type, row) {
					return '<a class="info">详情</a>'
							+ " <a onclick='showGoodList(\""+row.id+"\",\""+row.rep_name+"\");'>查看库存</a>";
				}
			}]
	...
	function showGoodList(repId,repName){
		var target = "${basePath}/jsp/emer/emerGoodsList.jsp?rep_id="+repId+"&rep_name="+repName;
		target = encodeURI(target);
		var v = {action:"menuItem", name:"应急物资", target: target};
		doMessage(v);
	}
</script>
</head>
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>
							<i class="fa fa-file-o a-clear"></i> 应急-仓库
						</h5>
					...
					<div class="ibox-content">
						...
						<div class="form-horizontal clearfix">
							<div class="col-sm-6 pl0">
								<s:access url="${basePath}/biz/emerRepository/insert.do">
									<button class="btn btn-sm btn-success" id="btn-insert">
										<i class="fa fa-plus"></i> 新增
									</button>
								</s:access>
								<s:access url="${basePath}/biz/emerRepository/update.do">
									<button class="btn btn-sm btn-success" id="btn-update">
										<i class="fa fa-edit"></i> 修改
									</button>
								</s:access>
								<s:access url="${basePath}/biz/emerRepository/delete.do">
				...
				<form id="editForm" class="form-horizontal key-13" role="form" onsubmit="return false;">
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="input-sm form-control validate[required]" name="rep_name" id="rep_name">
							</div>
							<label class="col-sm-2 control-label">仓库编号</label>
							<div class="col-sm-4">
								<input type="text" class="input-sm form-control" name="rep_no" id="rep_no">
							</div>
						</div>
						<div class="form-group">
