...
<script>
	...
	var deleteUrl = "${ctx}/jsp/xwgl/delete.do";
	...
	$(window).ready(function() {
		...
		var table = $("#datas").dataTable({
			...
			"columns": [ {
				...
				"title":"新闻标题  <i class='fa fa-search'></i>",
				"data":"xwgl_title",
				"render": function (data, type, row) {
				...
				"data":"xwgl_publish_time"
			},{
				"title":"创建时间 <i class='fa fa-search'></i>",
				"data":"created",
				"width":150
			}, {
				"title":"状态",
			...
			,"drawCallback": function(s) {
				...
				$(".info").off("click").on("click", function() {
					var target = "${basePath}/jsp/xwgl/xwglInfo.jsp?node=-1&orderId="+$(this).attr("value");
					var v = {action:"menuItem", name:"新闻信息查看", target: target};
					doMessage(v);
		       	});
			}
		});
		...
		$("#btn-insert").on("click", function() {
			var target = "${basePath}/jsp/xwgl/xwglInfo.jsp?node=0&orderId="+$(this).attr("value");
			var v = {action:"menuItem", name:"新闻信息新增", target: target};
			doMessage(v);
       	});
		//修改
		$("body").on("click", "#btn-update" , function() {
			...
			var target = "${basePath}/jsp/xwgl/xwglInfo.jsp?node=1&orderId="+ids[0];
			var v = {action:"menuItem", name:"新闻信息修改", target: target};
			doMessage(v);
       	});
        //删除
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>
							<class="fa fa-file-o a-clear"></i> 新闻列表
						</h5>
