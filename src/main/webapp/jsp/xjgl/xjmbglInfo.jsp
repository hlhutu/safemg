...
<script>
	var selectUrl = "${ctx}/biz/xjmbglInfo/select.do";
	var insertUrl = "${ctx}/biz/xjmbglInfo/insert.do";
	var updateUrl = "${ctx}/biz/xjmbglInfo/update.do";
	var deleteUrl = "${ctx}/biz/xjmbglInfo/delete.do";
				...
				<div class="ibox float-e-margins">
					<form id="editForm" class="form-horizontal key-13" role="form" onsubmit="return false;">
	           		<div class="ibox-title">
	                    <h5><i class="fa fa-pencil-square-o"></i>巡检模板任务项<span id="xjmc"></span></h5>
