...
import cn.scihi.emer.service.impl.EmerGoodsService;
 ...
 */
@Service
public class EmerGoodsUcc extends UccAdapter {

	@Autowired
	private EmerGoodsService emerGoodsService;

	public void init() throws Exception {
		super.setBaseService(emerGoodsService);
	}
