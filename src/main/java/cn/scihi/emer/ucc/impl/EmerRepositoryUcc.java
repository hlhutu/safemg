...
import cn.scihi.emer.service.impl.EmerRepositoryService;
 ...
 */
@Service
public class EmerRepositoryUcc extends UccAdapter {

	@Autowired
	private EmerRepositoryService emerRepositoryService;

	public void init() throws Exception {
		super.setBaseService(emerRepositoryService);
	}
