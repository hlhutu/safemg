...
import cn.scihi.emer.service.impl.EmerTeamService;
 ...
 */
@Service
public class EmerTeamUcc extends UccAdapter {

	@Autowired
	private EmerTeamService emerTeamService;

	public void init() throws Exception {
		super.setBaseService(emerTeamService);
	}
